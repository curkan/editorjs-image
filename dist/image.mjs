...
function S(C, a = null, i = {}) {
  ...
  for (const r in i)
    if (i.hasOwnProperty(r)) {
      const o = i[r];
      console.log(typeof o), typeof o == "boolean" ? s.setAttribute(r, o ? "true" : "false") : s.setAttribute(r, o);
    }
  return s;
}
    ...
    return function(i) {
      ...
      (function(o) {
        ...
        function p(n, c) {
          ...
          n._state !== 0 ? (n._handled = !0, l._immediateFn(function() {
            ...
            if (u !== null) {
              ...
              f(c.promise, g);
            } else (n._state === 1 ? f : y)(c.promise, n._value);
          })) : n._deferreds.push(c);
        }
        function f(n, c) {
          try {
        ...
        function w(n) {
          ...
          for (var c = 0, u = n._deferreds.length; c < u; c++) p(n, n._deferreds[c]);
          n._deferreds = null;
        }
        function b(n, c, u) {
      ...
      r(4);
      var e, d, v, l, p, f, y, w = r(8), b = (d = function(t) {
        ...
        switch (t.method) {
          ...
          case "UPDATE":
            ...
            (w.isFormData(t.data) || w.isFormElement(t.data)) && (c = e.FORM), t.data = f(t.data, c), c !== b.contentType.FORM && (t.headers["content-type"] = c);
        }
        return t;
      }, f = function() {
        var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      ...
      (function(o, e) {
        (function(d, v) {
          if (!d.setImmediate) {
            var l, p, f, y, w, b = 1, t = {}, n = !1, c = d.document, u = Object.getPrototypeOf && Object.getPrototypeOf(d);
            ...
            }) : c && "onreadystatechange" in c.createElement("script") ? (p = c.documentElement, l = function(h) {
      ...
      e.nextTick = function(u) {
        ...
        f.push(new n(u, g)), f.length !== 1 || y || l(t);
      ...
      i.exports = function() {
        ...
        var v, l, p;
        return v = d, p = [{ key: "urlEncode", value: function(f) {
          return e(f);
...
class P {
  ...
  renderSettings() {
    ...
    const s = a.filter((e) => {
      var v, l;
      const d = Object.keys(i).find((p) => i[p] === e.name);
